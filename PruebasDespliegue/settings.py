...
SECRET_KEY = 'django-insecure-i&(echk1od#dndm_w&cb^z1)cb^t$+h$c)_69!_g7)7$ag46b-'
...
WSGI_APPLICATION = 'PruebasDespliegue.asgi.application'
...
DATABASES = {
    'default': {
        ...
        'CONN_MAX_AGE': 1,  # Cerrar conexiones inmediatamente después de cada solicitud
